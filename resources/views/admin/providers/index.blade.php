    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-4">
                        <a href="{{ route('admin.provider.create') }}" class="btn btn-danger mb-2"><i
                                class="mdi mdi-plus-circle mr-2"></i> Add Providers</a>
...
<script>
    $(document).ready(function() {
        ...
        function fetchData(page) {
            $.ajax({
                url: "{{ route('api.provider.index') }}" + `?page=${page}`,
                method: 'GET',
                dataType: 'json',
                ...
                $('tbody').append('<tr>')
                    ...
                    .append(
                        `<td class="table-action">
                                <a href="/admin/provider/edit/${v.id}" class="action-icon"> 
        ...
        $('tbody').on('click', '.btn-delete', function(e) {
            ...
            swal({
                ...
                $.ajax({
                    type: "POST",
                    url: `/admin/provider/destroy/${dataId}`,
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "_method": 'DELETE'
                    },
